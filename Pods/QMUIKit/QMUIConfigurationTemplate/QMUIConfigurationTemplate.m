...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.tabBarShadowImageColor = UIColorClear;                                       // TabBarShadowImageColor : UITabBar 的 shadowImage 的颜色，会自动创建一张 1px 高的图片
    QMUICMI.tabBarTintColor = [UIColor colorWithRed:255.0/255.0 green:70/255.0 blue:34.0/255.0 alpha:1];                                              // TabBarTintColor : UITabBar 的 tintColor
